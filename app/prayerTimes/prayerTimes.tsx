          ...
          <div className="tab-content">
            ...
            <div className="masjid-picker">
              ...
              <div className="event-calendar-btn-group">
                <button
                  type="button"
                  className={`masjid-locate-btn${locateStatus === "found" ? " masjid-locate-btn--found" : ""}`}
                ...
                >
                  {locateStatus === "loading" ? (
                    ...
                    <>
                      <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" width="16" height="16" style={{ color: '#ef4444' }}>
            ...
            <div className="event-controls">
              <div className="event-controls__row">
                ...
                <div className="event-calendar-btn-group">
                  <button
                    type="button"
                    className={`masjid-locate-btn${userLocation ? " masjid-locate-btn--found" : ""}`}
